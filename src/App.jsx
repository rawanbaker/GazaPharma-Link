        ...
        <div style={{ flex: 1.2, background: "white", padding: "3rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <div style={{ display: "flex", gap: "10px", marginBottom: "1.5rem" }}>
            <button
              ...
              style={{ flex: 1, padding: "12px", borderRadius: "12px", border: "2px solid", borderColor: role === "patient" ? "#176b87" : "#d0d7de", background: role === "patient" ? "#e8f4f8" : "white", color: role === "patient" ? "#176b87" : "#888", fontWeight: "bold", cursor: "pointer", fontFamily: "Tahoma, Arial", fontSize: "14px" }}
            >
              🧑‍⚕️ Patient
            </button>
            <button
              onClick={() => { setRole("pharmacist"); setError("") }}
              style={{ flex: 1, padding: "12px", borderRadius: "12px", border: "2px solid", borderColor: role === "pharmacist" ? "#176b87" : "#d0d7de", background: role === "pharmacist" ? "#e8f4f8" : "white", color: role === "pharmacist" ? "#176b87" : "#888", fontWeight: "bold", cursor: "pointer", fontFamily: "Tahoma, Arial", fontSize: "14px" }}
            >
              💊 Pharmacist
            </button>
          </div>

          {/* حقل الإيميل — للمريض فقط */}
          {role === "patient" && (
            <div style={{ marginBottom: "1rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", background: "#f6f8fa", border: "1px solid #d0d7de", borderRadius: "12px", padding: "12px 14px" }}>
                ...
                <input
                  ...
                  style={{ border: "none", background: "transparent", outline: "none", fontSize: "15px", width: "100%", fontFamily: "Tahoma, Arial" }}
                />
              </div>
            </div>
          )}
          ...
          <div style={{ marginBottom: "1.2rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", background: "#f6f8fa", border: "1px solid #d0d7de", borderRadius: "12px", padding: "12px 14px" }}>
              ...
              <input
                type="password"
                placeholder={role === "pharmacist" ? "Pharmacist secret key..." : "••••••••"}
                value={password}
          ...
          {/* رسالة الخطأ */}
          {error && (
            <p style={{ color: "#e53e3e", fontSize: "13px", margin: "0 0 1rem", textAlign: "center" }}>
              ⚠️ {error}
            </p>
          )}
          ...
          <button
            onClick={handleLogin}
            style={{ width: "100%", padding: "14px", background: "#176b87", color: "white", border: "none", borderRadius: "12px", fontSize: "16px", fontWeight: "bold", cursor: "pointer", fontFamily: "Tahoma, Arial" }}
          >
